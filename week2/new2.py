...
def main():
    ...
    glfwSetCursorPosCallback(window, cursor_callback) # mouse cursor moving
    glfwSetMouseButtonCallback(window, button_callback) # mouse button click
    glfwSetScrollCallback(window, scroll_callback) # mouse wheel scroll
